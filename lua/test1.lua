...
if (gui_enabled()) then 
	...
	register_menu("test1/Evaluate", evaluate_lua, MENU_TOOLS_UNSORTED)
	register_menu("test1/Console", run_console, MENU_TOOLS_UNSORTED)
	register_menu("test1/Manual", ref_manual, MENU_TOOLS_UNSORTED)
	register_menu("test1/Wiki", wiki_page, MENU_TOOLS_UNSORTED)
end
